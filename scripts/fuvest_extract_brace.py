# -*- coding: utf-8 -*-
"""Extrai FUVEST F1 (90 q) de PDFs com marcador {NN} (FUVEST 2024/2025).
Baseado em fuvest_extract.py (marcador NN isolado). Texto via reading order
coluna-aware; figuras recortadas inline. Uso: python fuvest_extract_brace.py <ANO>"""
...
print("ANO", ANO, "| markers:", len(markers), "| faltando:", [n for n in range(1,91) if n not in markers])
...
print("questoes:", len(saida), "| != 5 alts:", [(q["numero"],q["n_alts"]) for q in saida if q["n_alts"]!=5])
