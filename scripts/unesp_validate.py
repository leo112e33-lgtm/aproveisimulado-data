# -*- coding: utf-8 -*-
"""Valida vestibular/unesp/<ANO>.json. Uso: python unesp_validate.py <ANO>"""
import json, os, re, sys
ANO = sys.argv[1] if len(sys.argv) > 1 else "2022"
HERE = os.path.dirname(__file__)
doc = json.load(open(os.path.join(HERE,"..","vestibular","unesp",f"{ANO}.json"),encoding="utf-8"))
...
print(f"UNESP {ANO}: {len(doc['questoes'])} questoes, {len(probs)} problemas")
